...
export const metadata = {
  title: "Software & SaaS AI Search Reports",
};
...
export default function Page() {
  return (
    <main className="uni-body panel bg-white text-tertiary-900">
      ...
      <section className="section panel position-relative overflow-hidden" style={{ minHeight: "56vh" }}>
        ...
        <div className="container max-w-xl" style={{ position: "relative" }}>
          <div className="panel vstack items-center text-center gap-2 md:gap-3 py-8 md:py-10 xl:py-12">
            <h1 className="h3 sm:h1 xl:display-6 m-0 text-white">Software & SaaS AI Search Reports</h1>
            <p className="fs-6 sm:fs-5 text-white opacity-90 m-0">
              Discover what your potential users are asking about Software & SaaS companies across ChatGPT, Google, and AI-powered search platforms
            </p>
      ...
      <AiReportOuterPageServer csvPath="/assets/ai-search-reports/software-and-saas.csv" basePath="/ai-search-query-industry-reports-and-benchmarking/software-and-saas" />
    </main>
  );
}

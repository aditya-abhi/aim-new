...
export default async function Blog2Page(props) {
  ...
  const jsonLdTechArticle = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id":
        "https://getaimonitor.com/google-sge-and-rag-in-ai-how-search-and-seo-are-changing-forever",
    },
    headline:
      "Google SGE and RAG in AI: How Search and SEO Are Changing Forever",
    description:
      "Explore how Google's Search Generative Experience (SGE) and Retrieval-Augmented Generation (RAG) are reshaping search and SEO. This guide delves into their impact on digital marketing strategies and offers insights on adapting to the evolving AI-driven search landscape.",
    image: "https://getaimonitor.com/assets/images/blog/Blog-sge-&-rag.webp",
    author: {
      "@type": "Person",
      name: "AI Monitor",

...
export default async function Blog2Page(props) {
  ...
  const jsonLdTechArticle = {
    ...
    description:
      "Explore how search is evolving from keywords to entities, driven by AI, NLP, and Google's Knowledge Graph and learn practical tips to optimize content for this next era of search.",
    image:
      "https://getaimonitor.com/assets/images/blog/future-of-search-understanding-entities-main-image.webp",
    author: {
      "@type": "Person",
      name: "AI Monitor",
    },

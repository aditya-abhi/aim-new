...
export default async function Blog2Page(props) {
  ...
  const jsonLdTechArticle = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id":
        "https://getaimonitor.com/top-10-game-changing-answer-engine-optimization-tools",
    },
    headline:
      "Answer Engine Optimization Tools: The Shocking Truth About AI Monitor",
    description:
      "Discover the top 10 Answer Engine Optimization (AEO) tools revolutionizing digital marketing in 2025. This guide explores cutting-edge platforms that enhance AI-driven search visibility, streamline content optimization, and provide actionable insights to dominate AI-powered search results.",
    image: "https://getaimonitor.com/assets/images/blog/aeo-tools.webp",
    author: {
      "@type": "Person",
      name: "AI Monitor",

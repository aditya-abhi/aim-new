...
export const metadata = {
  title:
    "AI Monitor, the Best Generative Engine Optimization Agency in Lucknow",
  description:
    "Boost your brand’s AI visibility with AI Monitor, Lucknow’s leading Generative Engine Optimization GEO agency. Get discovered by AI-tools.",
};

...
import BlogGoogleAI from "@/components/blogs/google-ai-overviews-what-we-know-so-far";
...
export default async function Blog2Page(props) {
  ...
  // const blogItem = "Google AI Overviews: What We Know So Far";
  return (
    <>
      <div className="page-wrapper uni-body panel bg-white text-gray-900 dark:bg-tertiary-800 dark:text-gray-200 overflow-x-hidden bp-xs bp-sm bp-md bp-lg bp-xl bp-xxl dom-ready">
        ...
        <div id="wrapper" className="wrap">
          <BlogGoogleAI blogItem={blogItem} />
          <Newsletter />
        </div>
        <Footer7 />
      </div>

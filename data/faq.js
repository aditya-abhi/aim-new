...
export const accordionItemsGEOCourse = [
  {
    id: 1,
    question: "Become a Trusted Source for AI",
    answer:
      "Position your content as an authoritative reference that AI platforms like ChatGPT and Google AI Overview prefer to cite in answers.",
    controls: "uc-accordion-24",
    expanded: true,
  },
  {
    ...
    answer:
      "Reach users directly through AI-generated answers—even when they don’t click search results.",
    controls: "uc-accordion-24",
    expanded: true,
  },
  {
    ...
    answer:
      "Adapt to the shift from traditional search to AI-led discovery and stay competitive as SEO evolves into GEO.",
    controls: "uc-accordion-24",
    expanded: true,
  },
  {
    ...
    answer:
      "Gain exposure in emerging generative platforms like Perplexity, Gemini, and Claude—where your competitors may not yet appear.",
    controls: "uc-accordion-24",
    expanded: true,
  },
  {
    ...
    answer:
      "Measure your brand’s visibility in AI engines, monitor citations, and refine your strategy using data-driven GEO tools.",
    controls: "uc-accordion-24",
    expanded: true,
  },
];

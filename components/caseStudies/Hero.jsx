              ...
              <div>
                ...
                >
                  ...
                  <p className="fs-5 xl:fs-4 text-black dark:text-white d-none md:d-block">
                    Discover how our AI-powered solutions help brands boost
                    visibility, drive growth, and lead in the digital landscape,
                    combining smart automation with strategic human insight.
                  </p>
                  <Link
                    href={`/page-pricing`}
                    className="btn btn-md lg:btn-lg btn-primary min-w-150px mt-2"
                  >
                    <span>Start Your AI Growth Journey</span>

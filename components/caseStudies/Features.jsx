                  ...
                  >
                    <div className="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                      ...
                      <div className="col-12 sm:col-6 order-1 lg:order-0">
                        <div className="panel vstack justify-between gap-4 h-100">
                          <div>
                            <div className="panel vstack gap-2">
                              ...
                              <h4 className="h6 lg:h5 xl:h4 mt-2">
                                <span className="text-primary h5 lg:h4 xl:h3">
                                  {feature.span}
                                </span>{" "}
                                {feature.heading}
                              </h4>
                          ...
                          <div>
                            <div className="p-3 panel vstack gap-2 rounded border">

...
import AccordionContact from "../common/AccordionContact";
            ...
            <div className="row child-cols-12 col-match g-4">
              ...
              <div>
                <div className="panel">
                  ...
                  >
                    <AccordionContact parentClass="panel p-2 md:p-3 lg:p-4 bg-secondary dark:bg-tertiary-700 rounded-1-5" />
                  </ul>
                </div>
              </div>
            </div>

...
const staticTocItems = [
  {
    ...
    level: 2,
    children: [
      { id: "getting-started-with-react", text: "Getting Started with React", level: 3 },
      { id: "setting-up-your-development-environment", text: "Setting Up Your Development Environment", level: 3 }
    ]
  },
  {
    ...
    level: 2,
    children: [
      { id: "asynchronous-programming", text: "Asynchronous Programming", level: 3 },
      { id: "es6-features", text: "ES6+ Features", level: 3 },
      { id: "error-handling-best-practices", text: "Error Handling Best Practices", level: 3 }
    ]
  },
  {
    ...
    level: 2,
    children: [
      { id: "code-splitting-and-lazy-loading", text: "Code Splitting and Lazy Loading", level: 3 }
    ]
  },
  {
    ...
    level: 2,
    children: [
      { id: "unit-testing-fundamentals", text: "Unit Testing Fundamentals", level: 3 },
      { id: "integration-testing-strategies", text: "Integration Testing Strategies", level: 3 }
    ]
  },
  {
    ...
    children: [
      ...
      { id: "container-orchestration", text: "Container Orchestration", level: 3 }
    ]
  },
  {
    ...
    level: 2,
    children: [
      { id: "authentication-and-authorization", text: "Authentication and Authorization", level: 3 }
    ]
  }
];
                ...
                <article className="post type-post panel">
                  <div className="row child-cols g-2 lg:g-3">
                    <div>
                      ...
                      {item.children && item.children.length > 0 && (
                        <div className="sub-headings mt-2 ms-4 ps-2" style={{ display: 'none' }}>

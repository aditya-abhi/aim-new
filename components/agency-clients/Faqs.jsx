import Accordion from "@/components/common/AccordionFeatures";
import React from "react";

export default function Faqs() {
  return (
    <div id="faq" className="faq section panel">
      <div className="section-outer panel lg:rounded-2 lg:mx-2 bg-tertiary-700">
            ...
            <div className="row child-cols-12 col-match g-4">
              <div>
                <div className="vstack items-center text-center gap-2">
                  <h2 className="h4 sm:h3 xl:h2 my-4 text-white opacity-80">

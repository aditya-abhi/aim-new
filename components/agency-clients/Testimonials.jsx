import { agency, testimonials3 } from "@/data/testimonials";
      ...
      <div className="section-outer panel py-6 xl:py-9">
        <div className="container max-w-lg">
          <div className="section-inner panel">
            ...
            >
              <h2 className="h4 sm:h3 lg:h2 m-0 text-center text-tertiary-700 dark:text-white">
                    ...
                    <div className="px-3 sm:px-4 py-4 panel vstack justify-between gap-3 rounded-2 border">
                      ...
                      <div className="panel hstack gap-2 mt-2 lg:mt-4">
                        ...
                        <div className="panel vstack items-start gap-0 ">
                          <h6 className="h6 m-0 text-gray-700 dark:text-white">
                            {testimonial.name}
                          </h6>

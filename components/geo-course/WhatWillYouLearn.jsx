      ...
      <div className="section-outer panel pt-6 lg:pt-8 xl:pt-10">
        <div className="container xl:max-w-xl">
          <div className="section-inner panel">
            <div
              className="panel vstack items-center gap-2 xl:gap-3 mb-4 lg:mb-8 max-w-900px mx-auto text-center"
              data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});"
            >
              <h2 className="h3 lg:h2 xl:h1 m-0 px-2">
                In-Demand Skills you'll Master attending our{" "}
                <span className="text-primary">
                  Best Generative Engine Optimization Course
                </span>
              </h2>
            ...
            <div className="row child-cols-12 lg:child-cols-5 col-match g-2">
              <div className="lg:col-7">
                <div
                  className="panel overflow-hidden bg-secondary text-gray-900 dark:bg-tertiary-700 dark:text-white rounded-2 lg:rounded-3"
                ...
                >
                  ...
                  >
                    ...
                    <p className="fs-6 md:fs-5 lg:fs-4 m-0">
                      Understand how ChatGPT, Google AI, and Copilot select and
                      prioritize content
                    </p>
                  </div>
                  ...
                  >
                    <div className="content vstack items-start gap-2">
                      ...
                      <p className="fs-6 lg:fs-5 dark:text-white">
                        Learning how to fine-tune and create content that
                        Generative engines love to reference and cite
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                >
                  ...
                  >
                    <div className="content vstack items-start gap-2">
                      <h4 className="h4 m-0">Technical Implementation</h4>
                      <p className="fs-6 lg:fs-5 dark:text-white">
                        Step-by-step processes to check AI crawlability of any
                        website.
                      </p>
                    </div>
                  </div>
              ...
              <div className="lg:col-7">
                <div
                  className="panel vstack items-start overflow-hidden bg-secondary text-gray-900 dark:bg-tertiary-700 dark:text-white rounded-2 lg:rounded-3"
                ...
                >
                  <div
                    ...
                    data-anime="onview: -100; targets: >*; translateY: [16, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 500});"
                  >
                    <h4 className="h4 m-0">GEO Performance Tracking</h4>
                    <p className="fs-6 md:fs-5 lg:fs-4 m-0 xl:px-4 text-center">
                      Measure your success in various Generative or Answer
                      Engine platforms and ecosystem
                    </p>
                  </div>

import { guideFocus, homeServices } from "@/data/features";
          ...
          <div className="section-inner panel vstack items-center gap-4 lg:gap-6 xl:gap-8">
            ...
            >
              ...
              <p className="fs-6 xl:fs-5 xl:px-8">
                We focus on clarity, transparency, and proven strategies that
                help brands understand and adapt to the realities of AI-powered
                search.
              </p>
            </div>
            <div

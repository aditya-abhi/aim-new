"use client";
import { accordionFeature3 } from "@/data/faq";
import { useEffect, useRef, useState } from "react";

export default function AccordionFeature3({
  faqData = accordionFeature3,
  parentClass = "",
}) {
  ...
  return (
    <>
      {faqData.map((item, index) => (
        ...
        >
          <a
            className="uc-accordion-title fw-bold fs-5 sm:fs-4 text-gray-900 dark:text-gray-700"
            role="button"
            aria-disabled="false"
          ...
          <div
            className="uc-accordion-content text-gray-800"

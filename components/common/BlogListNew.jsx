import { blogPostList, blogsPosts4 } from "@/data/blogs";
...
export default function BlogList() {
  ...
  return (
    <div className="section py-3 py-6 mt-6 lg:mt-6 lg:py-9 ">
        ...
        <div className="panel vstack gap-3 sm:gap-6 lg:gap-9">
          <header className="page-header vstack justify-center items-center text-center max-w-500px mx-auto">
            ...
            <p className="fs-6 lg:fs-5 opacity-60">
              Here are some of the latest news and trends you might be
              interested in.
            </p>
          </header>
            ...
            <div className="col">
              <div className="panel text-center">
                <div className="row child-cols-12 sm:child-cols-6 lg:child-cols-4 col-match gy-4 xl:gy-6 gx-2 sm:gx-4">
                  {blogPostList.slice(0, 9).map((elm, i) => (
                    <div key={i}>

          ...
          <div className="section-inner panel">
            ...
            >
              ...
              <h2 className="h3 lg:h2 xl:h1 m-0">
                Saving Brands From Becoming Digital Dinosaurs!
              </h2>
              <p className="fs-6 xl:fs-5 text-dark dark:text-white text-opacity-70">
                We help brands like yours stay ahead of the curve and avoid
                becoming digital dinosaurs by dominating results generated by
                AI-driven platforms such as ChatGPT, Google AI Overview, and the
                future AI overlords yet to come.
              </p>
            </div>
            <div
            ...
            >
              {featureItemsHome2.map((elm, i) => (
                <div key={i}>
                  <div className="feature-item panel py-6">

import { achievementsAEO, features11 } from "@/data/features";
...
export default function Achievements() {
  return (
    ...
    >
      <div className="section-outer panel py-6 md:py-8 xl:py-10 bg-tertiary-700 lg:mx-2 rounded-2">
          ...
          <div className="section-inner panel vstack items-center gap-4 lg:gap-6 xl:gap-8">
            ...
            >
              ...
              <h2 className="h3 lg:h2 m-0 text-white">
                ...
                <span className="text-primary">7-Day Intensive AEO Course</span>
              </h2>
            ...
            >
              {achievementsAEO.map((feature, index) => (
                  ...
                  <div className="features-item hstack items-start gap-2 lg:gap-4 p-2 lg:p-4 py-4 lg:py-6 bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent border border-dark dark:border-white dark:border-opacity-15 rounded-1-5">
                    ...
                    <div className="panel">
                      <div className="vstack gap-1">
                        ...
                        <p className="desc fs-6 text-white opacity-70">
                          {feature.description}
                        </p>
                      </div>
                    </div>

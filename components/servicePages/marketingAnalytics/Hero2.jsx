                ...
                >
                  ...
                  <div className="panel overflow-hidden pt-9 z-2">
                    <Image
                      className=""
                      alt="Main hero image"
                      src="/assets/images/portrait/8.webp"
                      width="1600"
                      height="1176"
                    />
                  </div>
                  ...
                  >
                    <Image
                      ...
                      alt="hero-image"
                      data-anime="onscroll: .hero-scroll-scene; onscroll-offset: -300; onscroll-trigger: 0; onscroll-duration: 700%; translateY: [-24, 180];"
                      src="/assets/images/media/marketing.webp"
                      width={845}
                      height={963}
                    />
                  </div>
                  ...
                  >
                    <Image
                      ...
                      src="/assets/images/services/Marketing-Analytics.webp"
                      width={656}
                      height={818}
                    />
                  </div>
                ...
                >
                  <h1 className="h2 sm:h1 lg:display-6 xl:display-5 mb-1 xl:mb-2">
                    <span className="mb-2 text-tertiary dark:text-secondary">
                      Turn Data into Decisions. Drive Growth
                    </span>
                  ...
                  <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                    AI-powered marketing analytics decodes customer behavior,
                    predicts trends, and delivers the insights that turn

import { stepsService10 } from "@/data/process";
          ...
          >
            <div className="panel p-4 md:p-6 lg:p-8 text-center items-center">
              <h2 className="h3 lg:h2 xl:h1 m-0">
                The Power of AI Marketing Analytics
              </h2>
              <p className="fs-6 xl:fs-5 fw-bold text-dark dark:text-white text-opacity-70 mt-2">
                ...
                processing to transform your marketing data into a clear,
                actionable roadmap.
              </p>
            </div>
            <div

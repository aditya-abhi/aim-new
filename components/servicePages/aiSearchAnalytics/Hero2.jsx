                ...
                >
                  ...
                  >
                    <Image
                      ...
                      alt="hero-image"
                      data-anime="onscroll: .hero-scroll-scene; onscroll-offset: -300; onscroll-trigger: 0; onscroll-duration: 700%; translateY: [-24, 180];"
                      src="/assets/images/media/AI-Search-Analytics.webp"
                      width={845}
                      height={963}
                    />
                  </div>
                  ...
                  >
                    <Image
                      ...
                      src="/assets/images/services/AI-Search-Analytics.webp"
                      width={656}
                      height={818}
                    />
                  </div>
              ...
              <div className="col-12 sm:col-9 lg:col-5 order-0 lg:order-1 pt-9 lg:pt-4">
                ...
                >
                  ...
                  <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                    Stop guessing and start knowing. Our AI-powered service
                    decodes user intent, predicts trends, and gives you the
                    strategic insights to win.
                  </p>

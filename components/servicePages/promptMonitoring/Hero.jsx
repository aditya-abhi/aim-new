...
export default function Hero() {
  return (
    <div id="hero_header" className="hero-header section panel overflow-hidden">
      <div className="position-absolute top-0 start-0 end-0 h-screen bg-secondary dark:bg-tertiary-700 rounded-bottom-2 mx-2" />
                  ...
                  <div className="panel vstack justify-center items-center gap-2 px-2 pt-4 text-center">
                    ...
                    >
                      <span className="mb-2 text-tertiary dark:text-primary">
                        Go Beyond Speculation. Monitor Prompts.
                      </span>
                    ...
                    <p
                      className="fs-6 xl:fs-4 xl:px-10 pt-4 lg:pt-6 dark:text-white text-opacity-70"
                    ...
                    >
                      Stop guessing which prompts deliver results, start
                      knowing. Our AI-powered monitoring reveals real-time
                      patterns, tracks user intent, and drives smarter AI
                      performance.
                    </p>
                    <div
                      ...
                      <div className="hstack justify-center gap-2">
                        ...
                        <div className="rating panel">
                          <div className="hstack justify-center">
                            ...
                            <i className="icon-1 unicon-star-filled text-yellow" />
                            <i className="icon-1 unicon-star-filled text-yellow" />
                            <i className="icon-1 unicon-star-half-filled text-yellow" />
                          </div>
                        </div>
                      </div>
                      <span className="desc">
                        with reviews on Trustpilot and G2
                      </span>
                    </div>
                  </div>

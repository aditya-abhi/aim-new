        ...
        <div className="container max-w-xl">
          <div className="section-inner panel">
            <div className="row child-cols justify-center lg:justify-between items-center gx-0">
                ...
                >
                  ...
                  <div className="panel overflow-hidden pt-9 z-2">
                    <Image
                      className=""
                      alt="Main hero image"
                      src="/assets/images/portrait/7.webp"
                      width="1600"
                      height="1176"
                    />
                  </div>
                  ...
                  >
                    <Image
                      ...
                      alt="hero-image"
                      data-anime="onscroll: .hero-scroll-scene; onscroll-offset: -300; onscroll-trigger: 0; onscroll-duration: 700%; translateY: [-24, 180];"
                      src="/assets/images/media/local-seo.webp"
                      width={845}
                      height={963}
                    />
                  </div>
                  ...
                  >
                    <Image
                      ...
                      src="/assets/images/services/local-seo.webp"
                      width={656}
                      height={818}
                    />
                  </div>
              ...
              <div className="col-12 sm:col-9 lg:col-5 order-0 lg:order-1 pt-9 lg:pt-8">
                <div
                ...
                >
                  ...
                  <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                    Our AI-powered Local SEO service decodes local intent,
                    predicts neighbourhood trends, and gives you the hyper-local
                    insights to win.
                  </p>

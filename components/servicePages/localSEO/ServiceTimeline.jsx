...
export default function ServiceTimeline() {
  return (
    ...
    <div className="geo-blueprint-root position-relative">
      <div className="geo-bg position-absolute top-0 start-0 w-100 h-100 bg-cover bg-center mt-4 lg:mt-6 xl:mt-8" />
      <div className="position-relative">
        <div className="blueprint-container text-tertiary">
          <h2 className="h2 lg:h1 text-tertiary dark:text-primary ">
            Our Roadmap to Local Search Dominance
          </h2>
          <p className="subtitle fs-6 lg:fs-5 text-gray-700 dark:text-white">
            Winning in local search isn’t luck, it’s location + strategy. Here’s
            how we guide your brand to own local storefronts and map packs.
          </p>
          ...
          <div className="timeline">
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    We kick off with a focused session to align on business
                    objectives, KPIs, and geo-driven growth targets, setting a
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Local Audit & Competitor Benchmarking</h3>
                  <p>
                    We analyze your Google Business Profile, map-pack
                    visibility, and competitors to uncover strengths, gaps, and
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Neighborhood & Intent Mapping</h3>
                  <p>
                    Define your Ideal Local Customer (ILC), map their search
                    intent, and reveal what drives local visits, calls, and
                    purchases, not just vanity clicks.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Geo-Keyword & Prompt Intelligence</h3>
                  <p>
                    Discover exactly what nearby customers search using “near
                    me” data and AI-driven prompts, so we optimize for
                    high-converting local queries.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>On-Page, Off-Page & Map Pack Optimization</h3>
                  <p>
                    Enhance your GBP, site, and citations with schema, NAP
                    accuracy, reviews, and local backlinks, building credibility
                    and visibility everywhere.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Custom 6-Month Local Growth Roadmap</h3>
                  <p>
                    Get a fully customized roadmap with content upgrades, review
                    strategies, citation boosts, and actionable steps to
                    dominate map packs.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Guided Launch & Local Rollout</h3>
                  <p>
                    We deliver localized briefs, execution plans, and checklists
                    to ensure a seamless, optimized rollout across your business
                    locations.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Performance-Driven Local Scaling</h3>
                  <p>
                    Identify top-performing locations, replicate winning
                    strategies, and maximize reach by scaling what drives the
                    highest ROI.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Ongoing Local Monitoring & Refinement</h3>
                  <p>
                    We track rankings, map-pack performance, and GBP actions
                    with monthly reports and continuous optimization to keep you
                    ahead.
                  </p>
                </div>
              </div>

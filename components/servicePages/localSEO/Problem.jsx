import { aeoService, localSEO, saasSeoService } from "@/data/features";
          ...
          <div className="section-inner panel vstack items-center gap-4 lg:gap-6 xl:gap-8">
            ...
            >
              ...
              <p className="fs-6 xl:fs-5 xl:px-8 dark:text-white">
                Traditional analytics only show where you appear, not why you’re
                not capturing nearby traffic.
              </p>
            </div>
            <div

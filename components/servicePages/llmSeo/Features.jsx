        ...
        <div className="container">
          ...
          >
            <div className="panel p-4 md:p-6 lg:p-8 text-center items-center">
              <h2 className="h3 lg:h2 xl:h1 m-0">The Power of LLM SEO</h2>
              <p className="fs-6 xl:fs-5 fw-bold text-dark dark:text-white text-opacity-70 mt-2">
                Our LLM SEO service uses structured machine-readable files to
                help AI engines understand, trust, and prioritize your content.
              </p>
            </div>
            <div

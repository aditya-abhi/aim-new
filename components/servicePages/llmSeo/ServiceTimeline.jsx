      ...
      <div className="position-relative">
        <div className="blueprint-container text-tertiary">
          <h2 className="h2 lg:h1 text-tertiary dark:text-primary">
            {" "}
            Our Roadmap to LLM SEO Success
          </h2>
          <p className="subtitle fs-6 lg:fs-5 text-gray-700 dark:text-white">
            Winning in AI-driven search isn’t luck—it’s strategy. Here’s how we
            position your brand to dominate ChatGPT, Google AI, Bing AI, Claude,
            and Perplexity.
          </p>
          ...
          <div className="timeline">
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    We start with a focused conversation to align on your
                    business objectives, KPIs, and timelines. This ensures
                    clarity from day one and provides a strong foundation for
                    all AI optimization activities.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>AI Visibility & Competitor Audit</h3>
                  <p>
                    Our team benchmarks your AI search visibility, evaluates
                    competitors ‘use of structured data, and uncovers gaps. This
                    analysis positions your brand as a preferred citation source
                    across AI-driven search and generative platforms.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>LLM Intent & Entity Mapping</h3>
                  <p>
                    We identify high-value prompts, AI-focused queries, and
                    entity relationships. By understanding exactly how AI
                    interprets your content, we maximize your chances of
                    appearing in generative summaries and trusted AI
                    recommendations.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    Merging AI prompt mining with traditional SEO insights, we
                    uncover the real questions your audience asks AI. This
                    enables precise optimization for both conventional search
                    traffic and AI-driven discovery.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>LLM SEO File Deployment</h3>
                  <p>
                    We create and implement five custom LLM SEO files for your
                    website. These files ensure AI engines can read, understand,
                    and prioritize your content, increasing your brand’s
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    You receive a tailored six-month AI optimization plan
                    outlining clear, prioritized steps. The roadmap focuses on
                    driving AI citations, improving rankings, and increasing
                    AI-driven visibility for your SaaS brand.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    Our team provides detailed briefs, integration checklists,
                    and expert support to make execution seamless. Whether
                    working alongside your team or managing the implementation
                    directly, we ensure strategies are applied effectively.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    ...
                    maximum leads, conversions, and ROI by leveraging AI
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    You receive monthly AI visibility reports covering
                    citations, impressions, rankings, and traffic. Ongoing
                    refinements ensure your SaaS brand stays ahead of
                    competitors and adapts to evolving AI search trends.
                  </p>
                </div>
              </div>
            </div>

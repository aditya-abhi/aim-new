import { servicePage4, servicePage5 } from "@/data/features";
          ...
          <div className="section-inner panel">
            ...
            >
              <h2 className="h3 lg:h2 xl:h1 m-0">
                What You'll Get from Our LLM SEO Service
              </h2>
              <p className="fs-6 xl:fs-5 text-dark dark:text-white text-opacity-70">
                We don’t just give you files, we deliver AI discoverability and
                authority.
              </p>
            </div>
            <div className="row child-cols-12 sm:child-cols-6 xl:child-cols-2 col-match justify-center g-2 lg:g-4">
              {servicePage5.map((feature, index) => (
                <div key={index}>
                  <div

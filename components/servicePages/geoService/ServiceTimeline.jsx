      ...
      <div className="position-relative">
        <div className="blueprint-container text-tertiary">
          <h2 className="h2 lg:h1 text-tertiary dark:text-primary">
            {" "}
            Your Roadmap to GEO Success
          </h2>
          <p className="subtitle fs-6 lg:fs-5 text-gray-700 dark:text-white">
            GEO isn’t SEO 2.0 - it’s the AI-era blueprint for dominating
            visibility across ChatGPT, Google AI, Perplexity, Bing AI, and
            beyond.
          </p>
          ...
          <div className="timeline">
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    We begin with a dedicated session to define your business
                    objectives, key performance indicators (KPIs), and
                    timelines. This ensures everyone is aligned on expectations
                    from day one, sets a clear roadmap for success, and provides
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>GEO Readiness Audit</h3>
                  <p>
                    We conduct a thorough assessment of your website, content,
                    and technical infrastructure to determine compatibility with
                    generative search engines. By benchmarking competitors, we
                    uncover opportunities to improve your AI visibility and
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    We map your Ideal Customer Profiles (ICP) and analyze
                    generative search intent. This step ensures that every piece
                    of content targets high-value AI-driven traffic, attracting
                    users who are most likely to convert, rather than chasing
                    vanity metrics.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>AI-Powered Query Analysis</h3>
                  <p>
                    Using advanced AI analytics, we uncover the exact questions
                    and prompts your audience uses. Understanding the intent
                    behind these queries allows us to align your content with
                    what AI users are actually searching for, increasing the
                    likelihood of your content being surfaced in generative
                    search results.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Content & Opportunity Mapping</h3>
                  <p>
                    We analyze your existing content and identify gaps where
                    users’ AI queries are not being fully addressed. By
                    strategically filling these gaps, we create content that
                    meets AI expectations, enhances discoverability, and
                    positions your brand as an authoritative source.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Enhanced AI Personalization</h3>
                  <p>
                    We tailor content to resonate with AI-driven
                    recommendations. This ensures responses feel relevant,
                    human-like, and engaging, increasing user satisfaction and
                    reinforcing your brand’s credibility in AI-generated
                    answers.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    We provide detailed briefs, templates, and step-by-step
                    checklists to make executing your GEO strategy
                    straightforward. If needed, we can assist directly to ensure
                    initiatives are implemented efficiently and remain fully
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    {" "}
                    We deliver monthly performance reports covering AI
                    visibility, content reach, engagement, and other key
                    metrics. Insights from these reports are used to
                    continuously refine strategies, optimize content, and ensure
                    your brand remains ahead of competitors in AI discovery.
                  </p>
                </div>
              </div>
            </div>
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>AI Visibility Expansion</h3>
                  <p>
                    We proactively track emerging AI platforms and generative
                    engines, optimizing your content to secure early visibility.
                    By staying ahead of trends, your brand gains first-mover
                    advantages, capturing opportunities before competitors can
                    respond.
                  </p>
                </div>
              </div>

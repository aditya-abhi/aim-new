import { geoService } from "@/data/features";
          ...
          <div className="section-inner panel vstack items-center gap-4 lg:gap-6 xl:gap-8">
            ...
            >
              ...
              <p className="fs-6 xl:fs-5 xl:px-8 dark:text-white">
                Traditional SEO speaks to search engines - GEO speaks to AI,
                ensuring your brand gets discovered, cited, and trusted.
              </p>
            </div>
            <div

import { stepsService3 } from "@/data/process";
          ...
          >
            <div className="panel p-4 md:p-6 lg:p-8 text-center items-center">
              ...
              <p className="fs-6 xl:fs-5 fw-bold text-dark dark:text-white text-opacity-70 mt-2">
                Our AEO service uses entity optimization, structured data, and
                AI-driven query analysis to help your brand dominate zero-click
                environments and own the answers users see.
              </p>
            </div>
            <div

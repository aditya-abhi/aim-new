      ...
      <div className="position-relative">
        <div className="blueprint-container text-tertiary">
          <h2 className="h2 lg:h1 text-tertiary dark:text-primary">
            {" "}
            Your Roadmap to AEO Success
          </h2>
          <p className="subtitle fs-6 lg:fs-5 text-gray-700 dark:text-white">
            AEO isn’t SEO 2.0, it’s the playbook for securing brand dominance in
          ...
          <div className="timeline">
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    Understand your business objectives, KPIs, and timelines to
                    ensure all efforts are strategically aligned from the start.
                    This lays the foundation for measurable outcomes and sets
                    clear expectations.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    Evaluate how your content and website perform in AI-driven
                    environments. Benchmark against competitors to identify
                    gaps, opportunities, and areas where your brand can gain an
                    early advantage in generative search results.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Answer Intent Mapping</h3>
                  <p>
                    Analyze the exact questions users are asking AI and
                    determine how to position your brand as the authoritative,
                    trusted source. This ensures your content addresses real
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    Align your brand and content with knowledge graphs,
                    structured data, and semantic connections to increase AI
                    trust and improve the likelihood of being surfaced in
                    AI-generated answers.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Answer-Ready Content Structuring</h3>
                  <p>
                    Create content specifically formatted for AI consumption,
                    including summaries, FAQs, and structured outputs, to
                    maximize visibility and engagement in generative search
                    environments.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Content Gap & Opportunity Mapping</h3>
                  <p>
                    Identify where AI engines are missing your brand or failing
                    to serve relevant answers. Strategically fill these gaps to
                    capture untapped traffic and establish thought leadership.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    Provide templates, briefs, and checklists for a seamless
                    rollout. If needed, we can assist directly to ensure
                    execution aligns with your AEO strategy and desired
                    outcomes.
                  </p>
                </div>
              </div>
            ...
            <div className="timeline-item right">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-135 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  ...
                  <p>
                    Track AI-driven metrics such as citations, mentions, content
                    reach, and engagement. Use insights to refine content and
            ...
            <div className="timeline-item left">
              <div className="content rounded-2 shadow-lg transition-all bg-secondary dark:bg-tertiary-800 dark:bg-gradient-45 from-tertiary to-transparent">
                ...
                <div className="text-tertiary dark:text-white">
                  <h3>Adaptive Strategy Updates</h3>
                  <p>
                    Stay ahead of AI algorithm changes and evolving ranking
                    signals. Regularly update your strategy to ensure sustained
                    authority, discoverability, and competitive advantage in
                    AI-driven search.
                  </p>
                </div>
              </div>

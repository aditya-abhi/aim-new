import { aeoService, geoService } from "@/data/features";
          ...
          <div className="section-inner panel vstack items-center gap-4 lg:gap-6 xl:gap-8">
            ...
            >
              ...
              <h2 className="h3 lg:h1 m-0">
                If AI Doesn’t Trust You,{" "}
                <span className="text-tertiary dark:text-primary">
                  It Won’t Cite You.
                </span>
              </h2>
              <p className="fs-6 xl:fs-5 xl:px-8 dark:text-white">
                SEO optimizes for searches, AEO optimizes for answers. Make your
                brand the chosen answer across ChatGPT, Google AI, Perplexity,

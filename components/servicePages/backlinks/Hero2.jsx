                ...
                >
                  ...
                  >
                    <Image
                      ...
                      alt="hero-image"
                      data-anime="onscroll: .hero-scroll-scene; onscroll-offset: -300; onscroll-trigger: 0; onscroll-duration: 700%; translateY: [-24, 180];"
                      src="/assets/images/media/backlinks.webp"
                      width={845}
                      height={963}
                    />
                  </div>
                  ...
                  >
                    <Image
                      ...
                      src="/assets/images/services/backlinks.webp"
                      width={656}
                      height={818}
                    />
                  </div>
              ...
              <div className="col-12 sm:col-9 lg:col-5 order-0 lg:order-1 pt-9 lg:pt-4">
                ...
                >
                  ...
                  <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                    High-quality backlinks and brand mentions from trusted
                    websites help you climb search rankings, strengthen brand
                    credibility, and drive measurable growth.
                  </p>

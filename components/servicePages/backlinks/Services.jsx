import { servicePage12, servicePage4 } from "@/data/features";
          ...
          <div className="section-inner panel">
            ...
            >
              ...
              <p className="fs-6 xl:fs-5 text-dark dark:text-white text-opacity-70">
                We don’t just deliver backlinks and mentions, we build
                authority, visibility, and a lasting competitive edge for your
                brand.
              </p>
            </div>
            <div className="row child-cols-12 sm:child-cols-6 xl:child-cols-2 col-match justify-center g-2 lg:g-4">
              {servicePage12.map((feature, index) => (
                <div key={index}>
                  <div

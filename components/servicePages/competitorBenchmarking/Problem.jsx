import { competitorBenchmarking } from "@/data/features";
          ...
          <div className="section-inner panel vstack items-center gap-4 lg:gap-6 xl:gap-8">
            ...
            >
              ...
              <p className="fs-6 xl:fs-5 xl:px-8 dark:text-white">
                Missing benchmarks can cost growth, revenue, and market share.
                Ignoring competitor insights leaves you vulnerable
              </p>
            </div>
            <div
            ...
            >
              {competitorBenchmarking.map((feature, index) => (

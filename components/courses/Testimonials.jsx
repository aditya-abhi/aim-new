        ...
        <div className="container xl:max-w-xl">
          ...
          >
            ...
            <div className="panel w-100 mask-x">
              ...
              >
                {coursesTestimonials.map((slide, index) => (
                  <SwiperSlide className="swiper-slide" key={index}>
                    <div className="panel vstack justify-between gap-3 p-3 lg:p-4 xl:p-6 bg-secondary text-black rounded-1-5 h-100">
              ...
              >
                {coursesTestimonials2.map((review, index) => (
                  <SwiperSlide

import { courses } from "@/data/features";
...
export default function Courses() {
  return (
    ...
    >
      <div className="section-outer panel py-4 md:py-6 xl:py-9 lg:mx-2 bg-tertiary-700 rounded-2">
          ...
          <div className="section-inner panel">
            ...
            >
              ...
              <p className="fs-6 xl:fs-5 text-white text-opacity-70">
                ...
                Answer Engines and Generative Engines, ensuring your brand
                ranks, gets cited, and stays discoverable across AI-driven
                platforms.
              </p>
            </div>
            <div
                          ...
                          <div className="panel vstack justify-center gap-4 h-100 sm:p-3 lg:p-4">
                            <div>
                              <div className="panel vstack gap-2">
                                ...
                                <h3 className="h4 sm:h3 xl:h2 m-0 text-secondary">
                                  {elm.title}
                                </h3>
                                <p className="fs-6 lg:fs-5 opacity-70 dark:opacity-80 text-white">
                                  {elm.description}
                                </p>
                                <a
                                  href={`${elm.link}`}

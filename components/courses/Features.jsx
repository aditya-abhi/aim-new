import { coursesFeatures, featureItems2 } from "@/data/features";
        ...
        <div className="container sm:max-w-lg xl:max-w-xl">
          <div className="section-inner panel">
            ...
            >
              ...
              <h2 className="h3 lg:h2 lg:h1 xl:display-6 m-0">
                Different Strategies,{" "}
                <span className="text-primary">One Unified Impact</span>
              </h2>
              <p className="fs-7 sm:fs-6 lg:fs-5 xl:fs-4 text-opacity-70">
                By combining AEO, GEO, AIO, and LLM SEO, your brand gains
                complete AI visibility, credibility, and lasting presence across
                answer engines and generative platforms.
              </p>
            </div>
            <div
            ...
            >
              {coursesFeatures.map((item, index) => (

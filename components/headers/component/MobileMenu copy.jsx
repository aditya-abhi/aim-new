      ...
      >
        <header className="uc-offcanvas-header hstack justify-between items-center pb-2 bg-white dark:bg-gray-900">
          <div className="uc-logo">
            ...
            >
              <Image
                className="w-32px dark:d-none"
                alt="AI Monitor Logo"
                src="/assets/images/common/logo-square-light.webp"
                width="34"
                height="34"
              />
              <Image
                className="w-32px d-none dark:d-block"
                alt="AI Monitor Logo"
                src="/assets/images/common/logo-square-dark.webp"
                width="34"
                height="34"
              />
            </Link>

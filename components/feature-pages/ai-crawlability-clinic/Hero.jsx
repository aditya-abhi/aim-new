                ...
                >
                  ...
                  >
                    <Image
                      ...
                      alt="app-dashboard"
                      src="/assets/images/template/ai-crawlability-clinic.webp"
                      width="1280"
                      height="853"
                    />
                  </div>
                  <div className="position-absolute top-50 end-0 translate-middle-y mt-2 lg:me-5">
                    <Image
                      className="w-250px text-primary lg:rounded-2 shadow-xl"
                      alt="app-dashboard-helper-1"
                      data-anime="scale: [0.5, 1]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 250;"
                      src="/assets/images/template/ai-crawlability-clinic-2.webp"
                      width="306"
                      height="583"
                    />
                  </div>

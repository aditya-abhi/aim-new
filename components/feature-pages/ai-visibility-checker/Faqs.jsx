import AccordionFeature1 from "@/components/common/AccordionFeature1";
            ...
            <div className="row child-cols-12 col-match g-4">
              ...
              <div>
                <div className="panel">
                  ...
                  >
                    <AccordionFeature1 parentClass="panel p-2 md:p-3 lg:p-4 bg-white rounded-1-5 dark:text-gray-900" />
                  </ul>
                </div>
              </div>
            </div>

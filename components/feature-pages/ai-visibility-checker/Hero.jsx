              ...
              <div>
                ...
                >
                  ...
                  <p className="fs-5 xl:fs-4 text-black dark:text-white d-none md:d-block">
                    Ever wondered what ChatGPT, Gemini, or Perplexity “really”
                    think about your brand? Stop guessing. Start knowing with
                    the only open-source monitoring tool built for AI
                    visibility.
                  </p>
                  <Link
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      alt="app-dashboard"
                      src="/assets/images/template/ai-visibility-tracking.webp"
                      width="1280"
                      height="853"
                    />
                  </div>
                  <div className="position-absolute top-50 end-0 translate-middle-y mt-2 lg:me-5">
                    <Image
                      className="w-350px text-primary lg:rounded-2 shadow-xl"
                      alt="app-dashboard-helper-1"
                      data-anime="scale: [0.5, 1]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 250;"
                      src="/assets/images/template/ai-visibility-tracking-2.webp"
                      width="306"
                      height="583"
                    />
                  </div>

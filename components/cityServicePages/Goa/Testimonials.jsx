...
export default function Testimonials() {
  return (
    <div
      id="testimonials"
      className="testimonials section panel overflow-hidden uc-dark"
    >
      <div className="section-outer panel py-6 lg:py-8 xl:py-10 bg-tertiary-700 rounded-2 mx-2">
            ...
            >
              <div className="section-header vstack items-center gap-2 lg:gap-3">
                ...
                <h2 className="h3 lg:h2 xl:h1 m-0 px-2 text-tertiary dark:text-white text-center">
                  ...
                  <span className="d-inline-flex px-1 text-primary">
                      ...
                      <div className="panel vstack items-center gap-4 text-center">
                        ...
                        <div className="panel vstack gap-2">
                          <div className="panel vstack gap-narrow">
                            ...
                            <span className="opacity-70 text-white opacity-80">
                              {testimonial.role}
                            </span>
                          </div>
                        </div>
